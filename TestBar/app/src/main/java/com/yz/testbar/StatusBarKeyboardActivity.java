...
public class StatusBarKeyboardActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_status_bar_keyboard);
        StatusBarKeyboardScrollView.assistActivity(this);
